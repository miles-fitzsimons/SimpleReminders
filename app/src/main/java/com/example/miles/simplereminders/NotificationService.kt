...
// MILES:  http://devdeeds.com/android-kotlin-create-and-schedule-notification/
...
class NotificationService: IntentService("NotificationService") {
    ...
    private fun createChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            notificationChannel.description = "Hello World!"//getString(R.string.notification_channel_description)
